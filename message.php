...
<body>
  ...
  <div class="contact2" style="background-image:url(img/unilabManda.jpg);height: 900px;" id="contact">
    <div class="container">
        ...
        <div class="col-lg-12">
          <div class="card card-shadow border-0 mb-4">
            <div class="row">
                ...
                <div class="contact-box p-4">
                  ...
                  <form action="partials/_manageContactUs.php" method="POST">
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group mt-3">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" aria-describedby="basic-addon" placeholder="Enter Your Phone Number" required pattern="[9][0-9]{9}" value="<?php echo $phone ?>">
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group mt-3">
                          ...
                          <input class="form-control" type="text" id="orderId" name="orderId" placeholder="Order ID" value="" required>
                      ...
                      <?php if ($loggedin) { ?>
                        <div class="col-lg-12">
                          <button type="submit" class="btn btn-primary mt-3 mb-3 text-white border-0 py-2 px-3"><span> Send Message <i class="ti-arrow-right"></i></span></button>
                          <button type="button" class="btn btn-success mt-3 mb-3 text-white border-0 py-2 px-3 mx-2" data-toggle="modal" data-target="#history"><span> Sent Messages <i class="ti-arrow-right"></i></span></button>
                        </div>
                      <?php } else { ?>
                        <div class="col-lg-12">
                          <button type="submit" class="btn btn-primary mt-3 text-white border-0 py-2 px-3" disabled><span> Send Message <i class="ti-arrow-right"></i></span></button>
              ...
              echo '<div class="col-lg-4 bg-image" style="background-image:url(img/banner.jpg)">
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color: rgb(187 188 189);">
          <h5 class="modal-title" id="adminReply">Replies from Admin</h5>
        ...
        <div class="modal-body" id="messagebd">
          <table class="table-striped table-bordered col-md-12 text-center">
            ...
            <tbody>
              ...
              if ($count == 0) {
              ?><script>
                  document.getElementById("messagebd").innerHTML = '<div class="my-1">You do not have any replies from the admin.</div>';
                </script> <?php
                        }
                          ?>
            </tbody>
        ...
        <div class="modal-body" id="bd">
          <table class="table-striped table-bordered col-md-12 text-center">
            ...
            <tbody>
              ...
              if ($count == 0) {
              ?><script>
                  document.getElementById("bd").innerHTML = '<div class="my-1">You have 0 sent messages.</div>';
                </script> <?php
                        }
                          ?>
            </tbody>
