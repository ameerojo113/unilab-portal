...
<head>
    ...
    <title>Our Company | Our Purpose and Value - Unilab</title>

    <!-- Default Meta Tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Unilab works towards a healthier Philippines by providing quality medicines.  Our core values are husay, malasakit and the Filipino spirit of bayanihan." />
    <meta name="keyword" content="Our Company | Our Purpose and Value - Unilab" />

    <!-- Open Graph Meta Tags -->
    <meta property="og:url" content="https://www.unilab.com.ph/our-purpose-our-values" />
    <meta property="og:title" content="Our Company | Our Purpose and Value - Unilab" />
    <meta property="og:description" content="Unilab works towards a healthier Philippines by providing quality medicines.  Our core values are husay, malasakit and the Filipino spirit of bayanihan." />
    ...
    <meta name="twitter:description" content="Unilab works towards a healthier Philippines by providing quality medicines.  Our core values are husay, malasakit and the Filipino spirit of bayanihan." />
    <meta name="twitter:title" content="Our Company | Our Purpose and Value - Unilab" />
    ...
    <link rel="canonical" href="https://www.unilab.com.ph/our-purpose-our-values" />
    <link rel="alternate" hreflang="en-PH" href="https://www.unilab.com.ph/our-purpose-our-values" />
    <link rel="alternate" hreflang="tl-PH" href="https://www.unilab.com.ph/our-purpose-our-values" />
</head>
<header>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row banner pullback">
            <div class="col-sm-6 col-md-6 banner-text">
                <h2 class="headline">Working towards a healthier Philippines, one quality medicine at a time.</h2>
                <h3 class="text">
        ...
        <div class="row subnavigation pullback">
            ...
            <div class="col-xs-12">
                ...
                <ul id="subnavcollapse" class="collapse">
                    ...
                    <li class="active"><a href="../our-purpose-our-values#subnavigation">Our
                            Purpose and Values</a></li>
                    ...
                    <li class=""><a href="../our-subsidiaries#subnavigation">Our Subsidiaries</a>
                    </li>
        ...
        </script><!-- YOUR HTML CODE HERE -->


        <div class="row container-content pullback p-0-b">
            <div id="purpose">
                <div class="col-xs-12">

                    <div class="sectionheadline"><span>Our Purpose</span></div>
                    <h3>Working towards a healthier Philippines, one quality medicine at a time.</h3>

                    <div class="text text-center"><br />
                        We believe that all Filipinos have the right to quality healthcare, to enable them to live full
                        and healthy lives. We want to work towards making them experience their best state of health, so
                        they can do what they need to do for the welfare of their families.</div>
            ...
            <div id="values">
                <div class="col-xs-12">
                    <div id="husay">
                        <div class="sectionheadline"><span>Our Values</span></div>

                        <h3 class="headline">Husay</h3>
                        <div class="husayimages">
                        </div>

                        <div class="husaytext">
                            <p>
                            <div class="husayimages"><img alt="" src="https://assets.unilab.com.ph/assets/assets/images/artimg-company-husay-drugstore1.jpg" />
                                <div class="husaytext text">
                                    <p style="text-align:center">We ensure <span style="color:#2980b9"><strong>excellence</strong></span> and <span style="color:#2980b9"><strong>quality</strong></span> in everything we
                                        do, knowing that each medicine we provide will promote and enrich lives of
                        ...
                        <h3 class="headline">Malasakit</h3>
                        <div class="husayimages">
                        </div>

                        <div class="husaytext">
                            <p>
                            <div class="husayimages"><img alt="" src="https://assets.unilab.com.ph/assets/assets/images/artimg-company-husay-drugstore2.jpg" />
                                <div class="husaytext text">
                                    <p style="text-align:center">We believe that every Filipino should receive <span style="color:#2980b9"><strong>unparalleled care</strong></span> when it
                                        comes to health. This means going above and beyond one&rsquo;s call of duty
                                        to be able to provide for our customer&rsquo;s health needs.&nbsp;</p>
                                </div>
                            </div>
                            </p>
                        </div>

                        <h3 class="headline">Bayanihan</h3>
                        <div class="husayimages">
                        </div>

                        <div class="husaytext">
                            <p>
                            <div class="husayimages"><img alt="" src="https://assets.unilab.com.ph/assets/assets/images/artimg-company-bayanihan.jpg" />
                                <div class="husaytext text">
                                    <p style="text-align:center">We believe in <span style="color:#2980b9"><strong>working together</strong></span> for a
                                        common goal and purpose, in the service of the Filipino.</p>
                                </div>
                            </div>
                            </p>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var site_name = "our-purpose-our-values";
    </script>
    <!-- "Please increase the version of the file if there are any changes and updates done. Ex. ?v=2 to ?v=3" -->
    ...
    <script>
        require(['config'], function() {
            ...
            require(['https://assets.unilab.com.ph/assets/assets/js/banner.js']);
        });
    </script>
    <!-- container-fluid -->
